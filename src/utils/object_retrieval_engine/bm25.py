...
class tf_idf_retrieval(load_file):
    def __init__(
            self,
            clean_data_path = {
                'bbox':'data_all/OD/bboxes_encoded/*',
                'class':'data_all/OD/classes_encoded/*',
                'color':'data_all/color/colors_encoded/*',
                'tag':'data_all/tag/*',
            },
            update:bool=False,
            save_tfids_object_path = os.path.join(PROJECT_ROOT, 'data_all/contexts_bin'),
            save_corpus_path = 'data_all/tag/tag_corpus.txt'
    ):
        super().__init__(
            clean_data_path,
            save_tfids_object_path,
