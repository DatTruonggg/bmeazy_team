...
class semantic_extract:
    def __init__(
            ...
            context_path = os.path.join(PROJECT_ROOT, "data_all/captions"),
            context_vector_path = os.path.join(PROJECT_ROOT, "data_all/TransNetDatabase/CaptionFeatures/context_vector.npy"),
            input_datatype = 'txt',
